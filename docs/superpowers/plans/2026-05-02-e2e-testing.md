...
**Goal:** Add Playwright E2E tests that validate integration between the Next.js frontend and the Rust/Axum backend, covering all 7 dashboard flows (health, API keys, credentials, proofs, events, usage, counterparties/issuer status).
